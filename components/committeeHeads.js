  ...
  return (
    <div className='w-full pt-40'>
        ...
        <div title='President' className='basis-1/2 flex justify-center'>
            ...
            <img className='aspect-square w-[150px] border-4 border-red-400' src='https://casamedia.com/wp-content/uploads/2023/04/adidas-1024x683.png' width={100} style={{borderRadius: '50%'}} />
        ...
        <div title='Vice President' className='basis-1/2 flex justify-center'>
            <div className='flex flex-col items-center gap-5'>
            <img className='aspect-square w-[200px] border-4 border-red-400' src='https://casamedia.com/wp-content/uploads/2023/04/adidas-1024x683.png' width={100} style={{}} />
            <div className='w-4/5 self-right'>
