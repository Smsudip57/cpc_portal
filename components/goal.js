...
export default function Goal() {
  return (
    <div className='w-4/5 mx-auto min-h-6 mt-28'>
      <p className='w-full text-center font-sans text-stone-700 text-3xl font-bold my-20'>Our G<img src='/arrow.png' className='inline w-5 h-5 mx-[1px]'/>als</p>
        <div className='max-w-1200px flex mx-auto gap-3 full'>
