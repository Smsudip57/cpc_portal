  ...
  return (
    <div className='w-4/5 pb-16 mx-auto'>
        <div className='flex gap-5 justify-center items-center'>
            ...
            <div className='bg-[#01AA4D] hover:bg-[#004e23] transition-colors duration-700 cursor-pointer rounded-tl-[80px] rounded-br-[80px] p-4 sm:p-6sm:text-[70px] text-[50px]  flex flex-col justify-center items-center'>
            ...
            <div className='bg-[#01AA4D] h-full hover:bg-[#004e23] transition-colors duration-700 cursor-pointer rounded-tr-[80px] rounded-bl-[80px] p-4 sm:p-6 sm:text-[70px] text-[50px] flex flex-col justify-center items-center'>
                ...
                <p className='text-base text-right px-2 sm:px-6'>See out past Events & Activities</p>
            </div>
            </Link>
        </div>
    </div>
